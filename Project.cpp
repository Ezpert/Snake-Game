...
int main()
{
	...
	while (1)
	{
		...
		while (!bDead)
		{
			...
			while ((chrono::system_clock::now() - t1) < ((nSnakeDirection % 2 == 1) ? 120ms : 150ms))
			{
			...
			wsprintf(&screen[nScreenWidth + 5], L"Bradley Vazquez - S N A K E ! !                  SCORE: %d", nScore, "      Food Y%d", nFoodY);
